...
export default function PlatformLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link to="/platform" className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold text-platform-slate">
              SafeStreets <span className="text-platform-navy">Intelligence</span>
            </span>
          </Link>

          {/* Desktop Nav */}
          <nav className="hidden md:flex items-center gap-6">
            <Link to="/" className="text-sm font-medium text-gray-600 hover:text-platform-navy transition">
              Try Free Tool
            </Link>
            <Link
              to="/platform/contact"
              className="px-5 py-2 bg-platform-navy text-white text-sm font-medium rounded-lg hover:bg-platform-navy-dark transition"
            >
              Contact Sales
            </Link>
          </nav>
        ...
        {mobileOpen && (
          <div className="md:hidden border-t border-gray-100 bg-white px-6 py-4 space-y-2">
            ...
            <Link to="/platform/contact" onClick={() => setMobileOpen(false)} className="block text-center px-5 py-2.5 bg-platform-navy text-white text-sm font-medium rounded-lg">
              Contact Sales
            </Link>
          </div>
        )}
      ...
      {/* Footer */}
      <footer className="bg-platform-slate text-white">
        <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="/platform/contact" className="text-sm text-gray-400 hover:text-white transition">Contact Sales</Link>

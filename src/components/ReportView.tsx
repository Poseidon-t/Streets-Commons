      ...
      <div className="max-w-4xl mx-auto p-12">
        ...
        <div className="page-break-after">
          ...
          <div className="text-center text-sm text-gray-500 mt-12">
            Generated by SafeStreets | Data sources: OpenStreetMap, Sentinel-2, NASA POWER, NHTSA FARS, WHO | Page 1 of 3
          </div>
        </div>
        ...
        <div className="page-break-after mt-12">
          ...
          <div className="text-center text-sm text-gray-500 mt-12">
            Generated by SafeStreets | Data sources: OpenStreetMap, Sentinel-2, NASA POWER, NHTSA FARS, WHO | Page 2 of 3
          </div>
        </div>
        ...
        <div className="mt-12">
          ...
          <div className="text-center text-sm text-gray-500 mt-12">
            Generated by SafeStreets | Data sources: OpenStreetMap, Sentinel-2, NASA POWER, NHTSA FARS, WHO | Page 3 of 3
          </div>
        </div>
      </div>

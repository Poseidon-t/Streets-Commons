        ...
        <div className="page-break-after mt-12">
          ...
          <div className="mt-8 bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-lg">
            ...
            <p className="text-sm text-yellow-800">
              This analysis is based on OpenStreetMap data contributed by local mappers. Some infrastructure may not yet be mapped. Satellite data is from Sentinel-2 (tree canopy). Street design scores use the EPA National Walkability Index (US only). Commute mode data is from US Census ACS.
            </p>
          </div>

  ...
  const metricsArray = [
    {
      ...
      icon: '🚶',
      standard: 'WHO: Crossings every 200m max',
      issue: 'Insufficient marked crosswalks force jaywalking and long detours',
      rec: 'Add marked crosswalks at key intersections, install pedestrian signals',
      impact: 'Reduces pedestrian accidents by 25-40%',
      cost: 'Low-Medium',
    },
    {
      name: 'Street Network',
    ...
    {
      name: 'Daily Needs Access',
      score: metrics.destinationAccess,
      icon: '🏪',
      standard: 'ITDP: Essential services within 15-min walk',
      ...
      impact: 'Reduces car trips by 20-30%, supports local economy',
      cost: 'Low (policy)',
    },
    {
    ...
    },
    {
      ...
      icon: '🌡️',
      standard: 'WHO: Thermal comfort for pedestrians',
      issue: 'High surface temperatures make walking uncomfortable and dangerous',
      rec: 'Increase cool pavements, add shade structures, expand tree canopy',
      impact: 'Reduces heat-related illness by 20-30%',
      cost: 'Medium',
    },
    {
      name: 'Air Quality',
      score: metrics.airQuality,
      icon: '💨',
      standard: 'WHO: PM2.5 < 15 µg/m³ annual average',
      issue: 'Poor air quality discourages outdoor activity and harms health',
      rec: 'Reduce vehicle emissions, expand green buffers, promote active transport',
      impact: 'Reduces respiratory issues by 15-25%',
      cost: 'Low (policy)',
    },
    {
      name: 'Heat Island Effect',
      score: metrics.heatIsland,
      icon: '🔥',
      standard: 'GSDG: Urban cooling strategies',
      issue: 'Concrete and asphalt absorb heat, creating dangerous hotspots',
      rec: 'Add green roofs, cool pavements, urban gardens, and water features',
      impact: 'Reduces local temperature by 2-5°C',
      cost: 'Medium',
    },

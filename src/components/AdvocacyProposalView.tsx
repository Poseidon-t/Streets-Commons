  ...
  const metricsArray = [
    {
      ...
      score: metrics.crossingSafety,
      icon: '🚦',
      standard: 'WHO: Crossings every 200m max, NACTO: signalized on 4+ lane roads',
      ...
      impact: 'Signalized crossings reduce pedestrian fatalities by 40-60%',
      cost: 'Low-Medium',
    },
    {
      ...
      icon: '🚶‍♀️',
      standard: 'Complete Streets: Sidewalks on 100% of urban streets',
      ...
      impact: 'Streets with sidewalks see 2-3x fewer pedestrian injuries',
      cost: 'Medium',
    },
    {
      name: 'Traffic Speed Safety',
      score: metrics.speedExposure,
      icon: '🚗',
      standard: 'Vision Zero: 20-25mph on urban streets',
      ...
      impact: 'Reducing speed from 40mph to 25mph cuts fatality risk from 85% to 10%',
      cost: 'Low-Medium',
    },
    {
    ...
    {
      name: 'Night Safety',
      score: metrics.nightSafety,
      icon: '💡',
      standard: 'IES: Minimum 5 lux on all pedestrian routes',
      ...
      impact: 'Good street lighting reduces pedestrian crashes by 42%',
      cost: 'Low-Medium',
    },
    {
    ...
    },
    {
      ...
      score: metrics.thermalComfort,
      icon: '🌡️',
      standard: 'WHO: Thermal comfort for pedestrians, heat island < 5°C',

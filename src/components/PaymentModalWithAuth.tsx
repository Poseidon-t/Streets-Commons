...
const FEATURES = [
  ...
  { name: 'AI Advocacy Letter', free: false, paid: true },
  { name: 'PDF Proposal Report', free: false, paid: true },
  { name: 'Budget Analysis', free: false, paid: true },
  { name: 'Compare Mode', free: false, paid: true },

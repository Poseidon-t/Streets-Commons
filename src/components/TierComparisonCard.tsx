...
const TIERS = [
  {
    ...
    features: [
      ...
      { name: 'AI Chatbot (6 messages)', included: true },
      { name: 'AI Advocacy Letter', included: false },
      { name: 'PDF Proposal Report', included: false },
      { name: 'Budget Analysis', included: false },
      { name: 'Compare Mode', included: false },
      { name: 'Street Redesign Mockup', included: false },
      { name: 'PDF / JSON Export', included: false },
      { name: 'Save Up To 10 Addresses', included: false },
    ],
  },
  {
    ...
    features: [
      ...
      { name: 'AI Advocacy Letter', included: true },
      { name: 'PDF Proposal Report', included: true },

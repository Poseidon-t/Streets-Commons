...
const TIERS = [
  {
    ...
    features: [
      ...
      { name: 'AI Advocacy Documents', included: false },
      { name: 'Street Redesign Mockup', included: false },
      { name: 'Unlimited AI Chatbot', included: false },
    ],
  },
  {
    ...
    features: [
      ...
      { name: 'AI Advocacy Documents', included: true },
      { name: 'Street Redesign Mockup', included: true },
      { name: 'Unlimited AI Chatbot', included: true },

          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white border-2 border-gray-100 rounded-2xl p-8">
              ...
              <ul className="space-y-3 mb-8">
                {['Interactive dashboard with core metrics', '3-day in-depth field audit (5 metrics)', 'Community survey & voice collection', '80+ page downloadable report', '6-week delivery'].map((f) => (
